...
public class AdapterCustomerDessert extends ArrayAdapter<Foods> {
    private String[] name;
    private String[] description;
    private String[] price;
    private Integer[] photo;

    public AdapterCustomerDessert(@NonNull Context context, ArrayList<Foods> listCustomerDesserts) {
        super(context, R.layout.custom_customer_menu, listCustomerDesserts);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        customView.findViewById(R.id.orderButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseOrder dbOrder = new DatabaseOrder(0 ,1,item,dbOrderState,false,new java.sql.Date(Calendar.getInstance().getTimeInMillis()));
                dbOrder.save();
